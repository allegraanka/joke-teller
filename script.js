...
// Disable / Enable Tell Joke Button by setting the boolean to the opposite of what it currently is
...
function tellMe(joke) {
    ...
    VoiceRSS.speech({
        key: '233f16b3ea484c37bda6e57db2971454',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    ...
    try {
        ...
        // Pass joke string into text-to-speech function
        tellMe(joke);
        // Disable button while joke is in process of being told
        toggleButton();
    } catch (error) {
        // Catch Errors Here
